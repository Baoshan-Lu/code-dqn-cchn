...
path = '../experiment/'+ datetime.now().strftime('%Y-%m-%d') + '-smoothl1loss_max7' + '/'
...
if __name__ == '__main__':
    ...
    parameters.add_argument('--epsion', type=int, default=0.9, help="epsion")
    ...
    parameters.add_argument('--loss_function', type=str, default='Smoothl1loss', choices=['MSE', 'Smoothl1loss'])
    ...
    Performace.compare_coalition_distrbuted_model(pu_num=5, su_num=8, crr_num=5,
                                           EPOCH=50, ITERATION=100,learningrate=0.01,epsion=0.9,
                                           batchsize=32, mode='su', model='double_dueling',
                                           power_num=[2,4,6],game_fail_num=200,sum_rate_type='su',show=True)
    # decision=cchn.init_alloation()
    # cr_router_energy_state_individual, cr_router_energy_state_total=cchn.calculate_cr_router_state_for_CI_link(decision)
    # print('decision:',decision)
    # print('cr_router_energy_state_individual:',cr_router_energy_state_individual)
    # print('cr_router_energy_state_individual[0]:',cr_router_energy_state_individual[0])
    # print('cr_router_energy_state_total:',cr_router_energy_state_total)
